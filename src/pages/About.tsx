        ...
        <div className="max-w-3xl mx-auto space-y-12">
          ...
          <section className="text-center space-y-4">
            ...
            <p className="text-xl text-muted-foreground leading-relaxed">
              귀여운 동물 캐릭터들이 펼치는 스릴 넘치는 경주 게임!<br />
              달리기와 수영, 두 가지 모드로 즐기세요. 누가 1등일지 아무도 모릅니다.
            </p>
          </section>
              ...
              {[
                {
                  icon: '🏊',
                  title: '달리기 & 수영 모드',
                  desc: '달리기와 수영 두 가지 경주 모드를 지원합니다. 수영 모드에서는 물살과 파도 이벤트가, 달리기 모드에서는 돌멩이 이벤트가 등장합니다.',
                },
                {
                  icon: '🎲',
                  title: '완전 랜덤 결과',
                ...
                },
                {
                  icon: '🐔',
                  title: '닭 변신 시스템',
                  desc: '닭을 선택하면 매 판마다 확률에 따라 변신! 60% 닭, 25% 병아리(🐣), 15% 불사조(🐦‍🔥). 불사조는 2배 크기에 5% 빠르고 장애물 면역, 병아리는 10% 느립니다.',
                },
                {
                  icon: '🪨',
                  title: '장애물 이벤트',
                  desc: '60% 확률로 경주 후반부에 장애물이 등장합니다. 달리기는 돌멩이, 수영은 파도! 선두 캐릭터가 넘어지는 극적인 역전이 가능합니다.',
                },
                {
                  icon: '🚤',
                  title: '배 부스터 (수영)',
                  desc: '수영 모드에서 60% 확률로 배 부스터가 등장! 랜덤한 레인의 20% 지점에 배치되며, 먹으면 4배 속도로 질주합니다.',
                },
                {
                  icon: '🏅',
                  title: '벌칙 시스템',
                  desc: '꼴찌 또는 특정 순위에 벌칙을 설정할 수 있습니다. 경주 모드에 따라 벌칙 색상도 변합니다.',
                },
                {
                  icon: '🐾',
                  title: '15종 동물 캐릭터',
                  desc: '강아지, 고양이, 토끼, 여우, 곰, 판다, 코알라, 사자, 호랑이, 소, 돼지, 개구리, 원숭이, 유니콘, 닭 중에서 선택하세요.',
                },
                {
                  icon: '🔥',
                  title: '몰아주기',
                  desc: '벌칙 대상이 2명 이상이면 몰아주기 가능! 벌칙 대상자끼리 한 번 더 경주해서 최종 1인에게 벌칙을 몰아줍니다.',
                },
                {
                  icon: '📊',
                  title: '실시간 순위',
